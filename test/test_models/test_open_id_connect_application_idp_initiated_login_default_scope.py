...
class TestOpenIdConnectApplicationIdpInitiatedLoginDefaultScope(unittest.TestCase):
    """OpenIdConnectApplicationIdpInitiatedLoginDefaultScope unit test stubs"""
    pass
