...
class TestApplicationPreviewSamlAppMetadataResponseEntityDescriptorIdpssoDescriptor(unittest.TestCase):
    """ApplicationPreviewSamlAppMetadataResponseEntityDescriptorIdpssoDescriptor unit test stubs"""
    pass
