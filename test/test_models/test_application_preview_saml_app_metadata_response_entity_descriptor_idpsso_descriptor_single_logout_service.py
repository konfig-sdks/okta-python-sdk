...
class TestApplicationPreviewSamlAppMetadataResponseEntityDescriptorIdpssoDescriptorSingleLogoutService(unittest.TestCase):
    """ApplicationPreviewSamlAppMetadataResponseEntityDescriptorIdpssoDescriptorSingleLogoutService unit test stubs"""
    pass
