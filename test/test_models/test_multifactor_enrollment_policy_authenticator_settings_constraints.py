...
class TestMultifactorEnrollmentPolicyAuthenticatorSettingsConstraints(unittest.TestCase):
    """MultifactorEnrollmentPolicyAuthenticatorSettingsConstraints unit test stubs"""
    pass
