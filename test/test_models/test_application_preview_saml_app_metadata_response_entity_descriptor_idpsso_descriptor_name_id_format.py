...
class TestApplicationPreviewSamlAppMetadataResponseEntityDescriptorIdpssoDescriptorNameIdFormat(unittest.TestCase):
    """ApplicationPreviewSamlAppMetadataResponseEntityDescriptorIdpssoDescriptorNameIdFormat unit test stubs"""
    pass
