...
from okta_python_sdk.exceptions_base import ApiValueError
from okta_python_sdk.exceptions import ClientConfigurationError
...
conf = okta_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://your-subdomain.okta.com" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if api_token:
            self.api_key['api_token'] = api_token
        else:
            raise ClientConfigurationError('API Key "api_token" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("okta_python_sdk")
