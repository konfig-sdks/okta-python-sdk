...
from okta_python_sdk.pydantic.secure_password_store_application_settings import SecurePasswordStoreApplicationSettings
...
class SecurePasswordStoreApplication(BaseModel):
    ...
    settings: typing.Optional[SecurePasswordStoreApplicationSettings] = Field(None, alias='settings')
