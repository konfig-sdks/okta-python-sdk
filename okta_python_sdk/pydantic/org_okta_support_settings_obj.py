...
from okta_python_sdk.pydantic.org_okta_support_setting import OrgOktaSupportSetting
...
class OrgOktaSupportSettingsObj(BaseModel):
    ...
    support: typing.Optional[OrgOktaSupportSetting] = Field(None, alias='support')
