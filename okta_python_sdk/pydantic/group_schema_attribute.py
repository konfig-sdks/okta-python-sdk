...
from okta_python_sdk.pydantic.group_schema_attribute_enum import GroupSchemaAttributeEnum
...
class GroupSchemaAttribute(BaseModel):
    ...
    enum: typing.Optional[GroupSchemaAttributeEnum] = Field(None, alias='enum')
