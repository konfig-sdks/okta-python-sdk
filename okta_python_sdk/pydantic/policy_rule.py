...
from okta_python_sdk.pydantic.policy_rule_actions import PolicyRuleActions
from okta_python_sdk.pydantic.policy_rule_conditions import PolicyRuleConditions

class PolicyRule(BaseModel):
    actions: typing.Optional[PolicyRuleActions] = Field(None, alias='actions')
    ...
    type: typing.Optional[Literal["SIGN_ON", "PASSWORD"]] = Field(None, alias='type')
