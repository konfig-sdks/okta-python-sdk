...
from okta_python_sdk.pydantic.authorization_server_policy_embedded import AuthorizationServerPolicyEmbedded
from okta_python_sdk.pydantic.authorization_server_policy_links import AuthorizationServerPolicyLinks
...
class AuthorizationServerPolicy(BaseModel):
    ...
    _embedded: typing.Optional[AuthorizationServerPolicyEmbedded] = Field(None, alias='_embedded')

    _links: typing.Optional[AuthorizationServerPolicyLinks] = Field(None, alias='_links')
