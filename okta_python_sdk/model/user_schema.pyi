...
class UserSchema(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def _links() -> typing.Type['UserSchemaLinks']:
                return UserSchemaLinks
            created = schemas.StrSchema
        
            @staticmethod
            def definitions() -> typing.Type['UserSchemaDefinitions']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["_links"]) -> 'UserSchemaLinks': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["created"]) -> MetaOapg.properties.created: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["definitions"]) -> 'UserSchemaDefinitions': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "$schema", "_links", "created", "definitions", "id", "lastUpdated", "name", "properties", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["_links"]) -> typing.Union['UserSchemaLinks', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["created"]) -> typing.Union[MetaOapg.properties.created, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["definitions"]) -> typing.Union['UserSchemaDefinitions', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "$schema", "_links", "created", "definitions", "id", "lastUpdated", "name", "properties", "type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _links: typing.Union['UserSchemaLinks', schemas.Unset] = schemas.unset,
        created: typing.Union[MetaOapg.properties.created, str, schemas.Unset] = schemas.unset,
        definitions: typing.Union['UserSchemaDefinitions', schemas.Unset] = schemas.unset,
