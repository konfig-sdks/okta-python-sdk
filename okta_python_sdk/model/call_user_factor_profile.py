...
class CallUserFactorProfile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["phoneExtension", "phoneNumber", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["phoneExtension", "phoneNumber", ], str]):
