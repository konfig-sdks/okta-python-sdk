...
class ApplicationVisibilityHide(
    ...
    class MetaOapg:
        ...
        class properties:
            iOS = schemas.BoolSchema
            web = schemas.BoolSchema
            __annotations__ = {
                "iOS": iOS,
                "web": web,
            }
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["iOS", "web", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["iOS", "web", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        iOS: typing.Union[MetaOapg.properties.iOS, bool, schemas.Unset] = schemas.unset,
        web: typing.Union[MetaOapg.properties.web, bool, schemas.Unset] = schemas.unset,
