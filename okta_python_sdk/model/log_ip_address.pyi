...
class LogIpAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "geographicalContext", "ip", "source", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "geographicalContext", "ip", "source", ], str]):
