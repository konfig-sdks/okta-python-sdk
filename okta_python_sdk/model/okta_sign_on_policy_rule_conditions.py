...
class OktaSignOnPolicyRuleConditions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["authContext", "network", "people", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["authContext", "network", "people", ], str]):
