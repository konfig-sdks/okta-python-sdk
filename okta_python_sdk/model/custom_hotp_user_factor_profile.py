...
class CustomHotpUserFactorProfile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sharedSecret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sharedSecret", ], str]):
