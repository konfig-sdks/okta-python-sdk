...
class ProvisioningConnectionProfile(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["authScheme", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["authScheme", "token", ], str]):
