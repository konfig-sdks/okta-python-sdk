...
class ThemeResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_links", "backgroundImage", "emailTemplateTouchPointVariant", "endUserDashboardTouchPointVariant", "errorPageTouchPointVariant", "favicon", "id", "logo", "primaryColorContrastHex", "primaryColorHex", "secondaryColorContrastHex", "secondaryColorHex", "signInPageTouchPointVariant", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
