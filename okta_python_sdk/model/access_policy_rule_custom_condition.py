...
class AccessPolicyRuleCustomCondition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["condition", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["condition", ], str]):
