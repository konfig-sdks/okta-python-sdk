...
class GroupSchemaAttribute(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def enum() -> typing.Type['GroupSchemaAttributeEnum']:
                return GroupSchemaAttributeEnum
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enum"]) -> 'GroupSchemaAttributeEnum': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "enum", "externalName", "externalNamespace", "items", "master", "maxLength", "minLength", "mutability", "oneOf", "permissions", "required", "scope", "type", "union", "unique", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enum"]) -> typing.Union['GroupSchemaAttributeEnum', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "enum", "externalName", "externalNamespace", "items", "master", "maxLength", "minLength", "mutability", "oneOf", "permissions", "required", "scope", "type", "union", "unique", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        enum: typing.Union['GroupSchemaAttributeEnum', schemas.Unset] = schemas.unset,
