...
class AcsEndpoint(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["index", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["index", "url", ], str]):
