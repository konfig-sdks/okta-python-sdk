...
class IdentityProviderCredentialsSigning(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["kid", "privateKey", "teamId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["kid", "privateKey", "teamId", ], str]):
