...
class SecurityQuestion(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["answer", "question", "questionText", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["answer", "question", "questionText", ], str]):
