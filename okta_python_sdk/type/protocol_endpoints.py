...
class RequiredProtocolEndpoints(TypedDict):
    pass

class OptionalProtocolEndpoints(TypedDict, total=False):
...
class ProtocolEndpoints(RequiredProtocolEndpoints, OptionalProtocolEndpoints):
    pass
