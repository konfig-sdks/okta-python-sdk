...
class BaseApi(api_client.Api):
    ...
    def _deactivate_zone_lifecycle_mapped_args(
        self,
        zone_id: str,
    ...
    async def _adeactivate_zone_lifecycle_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/zones/{zoneId}/lifecycle/deactivate',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _deactivate_zone_lifecycle_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeactivateZoneLifecycleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeactivate_zone_lifecycle(
        self,
        zone_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._deactivate_zone_lifecycle_mapped_args(
            zone_id=zone_id,
        )
        return await self._adeactivate_zone_lifecycle_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def deactivate_zone_lifecycle(
        self,
        zone_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._deactivate_zone_lifecycle_oapg(
            path_params=args.path,
        )

class DeactivateZoneLifecycle(BaseApi):
    ...
    async def adeactivate_zone_lifecycle(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adeactivate_zone_lifecycle(
            zone_id=zone_id,
            **kwargs,
        )
        if validate:
    ...
    def deactivate_zone_lifecycle(
        ...
        raw_response = self.raw.deactivate_zone_lifecycle(
            zone_id=zone_id,
        )
        if validate:
            return NetworkZonePydantic(**raw_response.body)
