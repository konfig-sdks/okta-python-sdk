...
class BaseApi(api_client.Api):
    ...
    def _update_profile_for_user_mapped_args(
        self,
        app_id: str,
        user_id: str,
    ...
    async def _aupdate_profile_for_user_oapg(
        self,
    ...
    def _update_profile_for_user_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateProfileForUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_profile_for_user(
        self,
        app_id: str,
        user_id: str,
        embedded: typing.Optional[AppUserEmbedded] = None,
        ...
        **kwargs,
        ...
        args = self._update_profile_for_user_mapped_args(
            app_id=app_id,
            user_id=user_id,
            embedded=embedded,
            links=links,
        ...
        return await self._aupdate_profile_for_user_oapg(
            body=args.body,
    ...
    def update_profile_for_user(
        ...
        return self._update_profile_for_user_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateProfileForUser(BaseApi):
    ...
    async def aupdate_profile_for_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_profile_for_user(
            app_id=app_id,
            user_id=user_id,
            embedded=embedded,
            links=links,
    ...
    def update_profile_for_user(
        ...
        raw_response = self.raw.update_profile_for_user(
            app_id=app_id,
            user_id=user_id,
            embedded=embedded,
            links=links,
