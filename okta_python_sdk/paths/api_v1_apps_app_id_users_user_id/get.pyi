...
class BaseApi(api_client.Api):
    ...
    def _get_specific_user_assignment_mapped_args(
        self,
        app_id: str,
        user_id: str,
    ...
    async def _aget_specific_user_assignment_oapg(
        self,
    ...
    def _get_specific_user_assignment_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSpecificUserAssignmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_user_assignment(
        self,
        app_id: str,
        user_id: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_specific_user_assignment_mapped_args(
            app_id=app_id,
            user_id=user_id,
            expand=expand,
        )
        return await self._aget_specific_user_assignment_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_user_assignment(
        self,
        app_id: str,
        user_id: str,
        expand: typing.Optional[str] = None,
        ...
        return self._get_specific_user_assignment_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSpecificUserAssignment(BaseApi):
    ...
    async def aget_specific_user_assignment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_user_assignment(
            app_id=app_id,
            user_id=user_id,
            expand=expand,
            **kwargs,
    ...
    def get_specific_user_assignment(
        ...
        raw_response = self.raw.get_specific_user_assignment(
            app_id=app_id,
            user_id=user_id,
            expand=expand,
        )
