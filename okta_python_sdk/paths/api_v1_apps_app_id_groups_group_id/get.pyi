...
class BaseApi(api_client.Api):
    ...
    def _get_group_assignment_mapped_args(
        self,
        app_id: str,
        group_id: str,
    ...
    async def _aget_group_assignment_oapg(
        self,
    ...
    def _get_group_assignment_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetGroupAssignmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_group_assignment(
        self,
        app_id: str,
        group_id: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_group_assignment_mapped_args(
            app_id=app_id,
            group_id=group_id,
            expand=expand,
        )
        return await self._aget_group_assignment_oapg(
    ...
    def get_group_assignment(
        ...
        return self._get_group_assignment_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetGroupAssignment(BaseApi):
    ...
    async def aget_group_assignment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_group_assignment(
            app_id=app_id,
            group_id=group_id,
            expand=expand,
            **kwargs,
    ...
    def get_group_assignment(
        ...
        raw_response = self.raw.get_group_assignment(
            app_id=app_id,
            group_id=group_id,
            expand=expand,
        )
