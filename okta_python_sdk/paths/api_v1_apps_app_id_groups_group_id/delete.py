...
class BaseApi(api_client.Api):
    ...
    def _remove_group_assignment_mapped_args(
        self,
        app_id: str,
        group_id: str,
    ...
    async def _aremove_group_assignment_oapg(
        self,
    ...
    def _remove_group_assignment_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveGroupAssignmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_group_assignment(
        self,
        app_id: str,
        group_id: str,
        **kwargs,
        ...
        args = self._remove_group_assignment_mapped_args(
            app_id=app_id,
            group_id=group_id,
        )
        return await self._aremove_group_assignment_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_group_assignment(
        self,
        app_id: str,
        group_id: str,
    ) -> typing.Union[
        ...
        return self._remove_group_assignment_oapg(
            path_params=args.path,
        )

class RemoveGroupAssignment(BaseApi):
    ...
    async def aremove_group_assignment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_group_assignment(
            app_id=app_id,
            group_id=group_id,
            **kwargs,
        )
    ...
    def remove_group_assignment(
        ...
        raw_response = self.raw.remove_group_assignment(
            app_id=app_id,
            group_id=group_id,
        )
