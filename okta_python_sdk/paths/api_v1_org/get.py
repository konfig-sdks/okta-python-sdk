...
class BaseApi(api_client.Api):
    ...
    def _get_settings_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_settings_oapg(
        self,
...
class GetSettingsRaw(BaseApi):
    ...
    async def aget_settings(
        ...
        **kwargs,
        ...
        args = self._get_settings_mapped_args(
        )
        return await self._aget_settings_oapg(
            **kwargs,
        )
...
class GetSettings(BaseApi):
    ...
    async def aget_settings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_settings(
            **kwargs,
        )
        if validate:
    ...
    def get_settings(
        ...
        raw_response = self.raw.get_settings(
        )
        if validate:
            return OrgSettingPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrgSettingPydantic, raw_response.body)
