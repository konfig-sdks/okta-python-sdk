...
class BaseApi(api_client.Api):
    ...
    def _get_grant_by_id_mapped_args(
        self,
        user_id: str,
        grant_id: str,
    ...
    async def _aget_grant_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/users/{userId}/grants/{grantId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetGrantByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_grant_by_id(
        self,
        user_id: str,
        grant_id: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_grant_by_id_mapped_args(
            user_id=user_id,
            grant_id=grant_id,
            expand=expand,
        )
        return await self._aget_grant_by_id_oapg(
    ...
    def get_grant_by_id(
        ...
        return self._get_grant_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetGrantById(BaseApi):
    ...
    async def aget_grant_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_grant_by_id(
            user_id=user_id,
            grant_id=grant_id,
            expand=expand,
            **kwargs,
    ...
    def get_grant_by_id(
        ...
        raw_response = self.raw.get_grant_by_id(
            user_id=user_id,
            grant_id=grant_id,
            expand=expand,
        )
