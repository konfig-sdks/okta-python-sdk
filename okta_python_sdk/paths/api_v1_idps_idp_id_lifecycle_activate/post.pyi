...
class BaseApi(api_client.Api):
    ...
    def _activate_idp_lifecycle_mapped_args(
        self,
        idp_id: str,
    ...
    async def _aactivate_idp_lifecycle_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/idps/{idpId}/lifecycle/activate',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _activate_idp_lifecycle_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ActivateIdpLifecycleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aactivate_idp_lifecycle(
        self,
        idp_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._activate_idp_lifecycle_mapped_args(
            idp_id=idp_id,
        )
        return await self._aactivate_idp_lifecycle_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def activate_idp_lifecycle(
        self,
        idp_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._activate_idp_lifecycle_oapg(
            path_params=args.path,
        )

class ActivateIdpLifecycle(BaseApi):
    ...
    async def aactivate_idp_lifecycle(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aactivate_idp_lifecycle(
            idp_id=idp_id,
            **kwargs,
        )
        if validate:
    ...
    def activate_idp_lifecycle(
        ...
        raw_response = self.raw.activate_idp_lifecycle(
            idp_id=idp_id,
        )
        if validate:
            return IdentityProviderPydantic(**raw_response.body)
