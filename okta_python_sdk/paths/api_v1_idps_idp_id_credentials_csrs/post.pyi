...
class GenerateCsrRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_csr(
        self,
        idp_id: str,
        subject: typing.Optional[CsrMetadataSubject] = None,
        subject_alt_names: typing.Optional[CsrMetadataSubjectAltNames] = None,
        **kwargs,
        ...
        args = self._generate_csr_mapped_args(
            body=body,
            idp_id=idp_id,
            subject=subject,
            subject_alt_names=subject_alt_names,
        )
        return await self._agenerate_csr_oapg(
            body=args.body,
    ...
    def generate_csr(
        ...
        return self._generate_csr_oapg(
            body=args.body,
            path_params=args.path,
        )

class GenerateCsr(BaseApi):
    ...
    async def agenerate_csr(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_csr(
            body=body,
            idp_id=idp_id,
            subject=subject,
            subject_alt_names=subject_alt_names,
    ...
    def generate_csr(
        ...
        raw_response = self.raw.generate_csr(
            body=body,
            idp_id=idp_id,
            subject=subject,
            subject_alt_names=subject_alt_names,
