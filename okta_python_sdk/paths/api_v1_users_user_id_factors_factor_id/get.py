...
class GetFactorRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_factor(
        self,
        user_id: str,
        factor_id: str,
        **kwargs,
        ...
        args = self._get_factor_mapped_args(
            user_id=user_id,
            factor_id=factor_id,
        )
        return await self._aget_factor_oapg(
    ...
    def get_factor(
        ...
        return self._get_factor_oapg(
            path_params=args.path,
        )

class GetFactor(BaseApi):
    ...
    async def aget_factor(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_factor(
            user_id=user_id,
            factor_id=factor_id,
            **kwargs,
        )
    ...
    def get_factor(
        ...
        raw_response = self.raw.get_factor(
            user_id=user_id,
            factor_id=factor_id,
        )
        if validate:
