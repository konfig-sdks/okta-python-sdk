...
from okta_python_sdk.model.identity_provider_list_response import IdentityProviderListResponse as IdentityProviderListResponseSchema

from okta_python_sdk.type.identity_provider_list_response import IdentityProviderListResponse

from ...api_client import Dictionary
from okta_python_sdk.pydantic.identity_provider_list_response import IdentityProviderListResponse as IdentityProviderListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = IdentityProviderListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IdentityProviderListResponsePydantic:
        ...
        if validate:
            return RootModel[IdentityProviderListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(IdentityProviderListResponsePydantic, raw_response.body)
