...
class BaseApi(api_client.Api):
    ...
    def _update_success_mapped_args(
        self,
    ...
    async def _aupdate_success_oapg(
        self,
...
class UpdateSuccessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_success(
        self,
        trusted_origin_id: str,
        links: typing.Optional[TrustedOriginLinks] = None,
        created: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._update_success_mapped_args(
        ...
        return await self._aupdate_success_oapg(
            body=args.body,
    ...
    def update_success(
        ...
        return self._update_success_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSuccess(BaseApi):
    ...
    async def aupdate_success(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_success(
            trusted_origin_id=trusted_origin_id,
            links=links,
            created=created,
            created_by=created_by,
    ...
    def update_success(
        ...
        raw_response = self.raw.update_success(
            trusted_origin_id=trusted_origin_id,
            links=links,
            created=created,
            created_by=created_by,
