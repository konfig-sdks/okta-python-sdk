...
class BaseApi(api_client.Api):
    ...
    def _update_existing_type_mapped_args(
        self,
        type_id: str,
    ...
    async def _aupdate_existing_type_oapg(
        self,
    ...
    def _update_existing_type_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExistingTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_existing_type(
        self,
        type_id: str,
        description: typing.Optional[str] = None,
        links: typing.Optional[UserTypeLinks] = None,
        ...
        **kwargs,
        ...
        args = self._update_existing_type_mapped_args(
            type_id=type_id,
        ...
        return await self._aupdate_existing_type_oapg(
            body=args.body,
    ...
    def update_existing_type(
        ...
        return self._update_existing_type_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExistingType(BaseApi):
    ...
    async def aupdate_existing_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_existing_type(
            type_id=type_id,
            description=description,
            links=links,
            created=created,
    ...
    def update_existing_type(
        ...
        raw_response = self.raw.update_existing_type(
            type_id=type_id,
            description=description,
            links=links,
            created=created,
