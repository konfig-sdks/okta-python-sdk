...
class RemoveSmsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_sms(
        self,
        template_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_sms_mapped_args(
            template_id=template_id,
        )
        return await self._aremove_sms_oapg(
    ...
    def remove_sms(
        ...
        return self._remove_sms_oapg(
            path_params=args.path,
        )

class RemoveSms(BaseApi):
    ...
    async def aremove_sms(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_sms(
            template_id=template_id,
            **kwargs,
        )
    ...
    def remove_sms(
        ...
        raw_response = self.raw.remove_sms(
            template_id=template_id,
        )
