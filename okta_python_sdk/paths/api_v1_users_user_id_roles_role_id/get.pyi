...
class BaseApi(api_client.Api):
    ...
    def _get_assigned_role_mapped_args(
        self,
        user_id: str,
        role_id: str,
    ...
    async def _aget_assigned_role_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/users/{userId}/roles/{roleId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAssignedRoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_assigned_role(
        self,
        user_id: str,
        role_id: str,
        **kwargs,
        ...
        args = self._get_assigned_role_mapped_args(
            user_id=user_id,
            role_id=role_id,
        )
        return await self._aget_assigned_role_oapg(
    ...
    def get_assigned_role(
        ...
        return self._get_assigned_role_oapg(
            path_params=args.path,
        )

class GetAssignedRole(BaseApi):
    ...
    async def aget_assigned_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_assigned_role(
            user_id=user_id,
            role_id=role_id,
            **kwargs,
        )
    ...
    def get_assigned_role(
        ...
        raw_response = self.raw.get_assigned_role(
            user_id=user_id,
            role_id=role_id,
        )
        if validate:
