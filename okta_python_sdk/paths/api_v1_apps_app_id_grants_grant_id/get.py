...
GrantIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'appId': typing.Union[AppIdSchema, str, ],
        'grantId': typing.Union[GrantIdSchema, str, ],
    }
)
...
request_path_grant_id = api_client.PathParameter(
    name="grantId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=GrantIdSchema,
    required=True,
)
_auth = [
    'api_token',
]
SchemaFor200ResponseBodyApplicationJson = OAuth2ScopeConsentGrantSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_single_scope_consent_grant_mapped_args(
        self,
        app_id: str,
        grant_id: str,
    ...
    async def _aget_single_scope_consent_grant_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/apps/{appId}/grants/{grantId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_single_scope_consent_grant_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetSingleScopeConsentGrantRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_scope_consent_grant(
        self,
        app_id: str,
        grant_id: str,
        expand: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_single_scope_consent_grant_mapped_args(
            app_id=app_id,
            grant_id=grant_id,
            expand=expand,
        )
        return await self._aget_single_scope_consent_grant_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_single_scope_consent_grant(
        self,
        app_id: str,
        grant_id: str,
        expand: typing.Optional[str] = None,
        ...
        return self._get_single_scope_consent_grant_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSingleScopeConsentGrant(BaseApi):
    ...
    async def aget_single_scope_consent_grant(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_scope_consent_grant(
            app_id=app_id,
            grant_id=grant_id,
            expand=expand,
            **kwargs,
    ...
    def get_single_scope_consent_grant(
        ...
        raw_response = self.raw.get_single_scope_consent_grant(
            app_id=app_id,
            grant_id=grant_id,
            expand=expand,
        )
