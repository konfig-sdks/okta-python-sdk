...
class GetByIdpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_idp(
        self,
        idp_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_by_idp_mapped_args(
            idp_id=idp_id,
        )
        return await self._aget_by_idp_oapg(
    ...
    def get_by_idp(
        ...
        return self._get_by_idp_oapg(
            path_params=args.path,
        )

class GetByIdp(BaseApi):
    ...
    async def aget_by_idp(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_idp(
            idp_id=idp_id,
            **kwargs,
        )
        if validate:
    ...
    def get_by_idp(
        ...
        raw_response = self.raw.get_by_idp(
            idp_id=idp_id,
        )
        if validate:
            return IdentityProviderPydantic(**raw_response.body)
