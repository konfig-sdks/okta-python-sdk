...
class BaseApi(api_client.Api):
    ...
    def _create_new_user_type_mapped_args(
        self,
    ...
    async def _acreate_new_user_type_oapg(
        self,
    ...
    def _create_new_user_type_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateNewUserTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_user_type(
        self,
        description: typing.Optional[str] = None,
        links: typing.Optional[UserTypeLinks] = None,
        created: typing.Optional[datetime] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_user_type_mapped_args(
        ...
        return await self._acreate_new_user_type_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_user_type(
        ...
        return self._create_new_user_type_oapg(
            body=args.body,
        )

class CreateNewUserType(BaseApi):
    ...
    async def acreate_new_user_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_user_type(
            description=description,
            links=links,
            created=created,
            created_by=created_by,
    ...
    def create_new_user_type(
        ...
        raw_response = self.raw.create_new_user_type(
            description=description,
            links=links,
            created=created,
            created_by=created_by,
