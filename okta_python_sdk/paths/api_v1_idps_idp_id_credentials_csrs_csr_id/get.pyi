...
class BaseApi(api_client.Api):
    ...
    def _get_csr_by_idp_mapped_args(
        self,
        idp_id: str,
        csr_id: str,
    ...
    async def _aget_csr_by_idp_oapg(
        self,
...
class GetCsrByIdpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_csr_by_idp(
        self,
        idp_id: str,
        csr_id: str,
        **kwargs,
        ...
        args = self._get_csr_by_idp_mapped_args(
            idp_id=idp_id,
            csr_id=csr_id,
        )
        return await self._aget_csr_by_idp_oapg(
    ...
    def get_csr_by_idp(
        ...
        return self._get_csr_by_idp_oapg(
            path_params=args.path,
        )

class GetCsrByIdp(BaseApi):
    ...
    async def aget_csr_by_idp(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_csr_by_idp(
            idp_id=idp_id,
            csr_id=csr_id,
            **kwargs,
        )
    ...
    def get_csr_by_idp(
        ...
        raw_response = self.raw.get_csr_by_idp(
            idp_id=idp_id,
            csr_id=csr_id,
        )
        if validate:
