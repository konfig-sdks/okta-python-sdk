...
# Query params
ValidityYearsSchema = schemas.IntSchema
...
class BaseApi(api_client.Api):
    ...
    def _generate_x509_certificate_mapped_args(
        self,
        app_id: str,
        validity_years: typing.Optional[int] = None,
    ...
    async def _agenerate_x509_certificate_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/apps/{appId}/credentials/keys/generate',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _generate_x509_certificate_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GenerateX509CertificateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_x509_certificate(
        self,
        app_id: str,
        validity_years: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._generate_x509_certificate_mapped_args(
            app_id=app_id,
            validity_years=validity_years,
        )
        return await self._agenerate_x509_certificate_oapg(
    ...
    def generate_x509_certificate(
        ...
        return self._generate_x509_certificate_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GenerateX509Certificate(BaseApi):
    ...
    async def agenerate_x509_certificate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_x509_certificate(
            app_id=app_id,
            validity_years=validity_years,
            **kwargs,
        )
    ...
    def generate_x509_certificate(
        ...
        raw_response = self.raw.generate_x509_certificate(
            app_id=app_id,
            validity_years=validity_years,
        )
        if validate:
