...
class BaseApi(api_client.Api):
    ...
    def _get_key_credential_mapped_args(
        self,
        app_id: str,
        key_id: str,
    ...
    async def _aget_key_credential_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/apps/{appId}/credentials/keys/{keyId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetKeyCredentialRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_key_credential(
        self,
        app_id: str,
        key_id: str,
        **kwargs,
        ...
        args = self._get_key_credential_mapped_args(
            app_id=app_id,
            key_id=key_id,
        )
        return await self._aget_key_credential_oapg(
    ...
    def get_key_credential(
        ...
        return self._get_key_credential_oapg(
            path_params=args.path,
        )

class GetKeyCredential(BaseApi):
    ...
    async def aget_key_credential(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_key_credential(
            app_id=app_id,
            key_id=key_id,
            **kwargs,
        )
    ...
    def get_key_credential(
        ...
        raw_response = self.raw.get_key_credential(
            app_id=app_id,
            key_id=key_id,
        )
        if validate:
