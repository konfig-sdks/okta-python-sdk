...
class BaseApi(api_client.Api):
    ...
    def _update_profile_mapped_args(
        self,
        group_id: str,
    ...
    async def _aupdate_profile_oapg(
        self,
...
class UpdateProfileRaw(BaseApi):
    ...
    async def aupdate_profile(
        ...
        **kwargs,
        ...
        args = self._update_profile_mapped_args(
            group_id=group_id,
            embedded=embedded,
            links=links,
            created=created,
        ...
        return await self._aupdate_profile_oapg(
            body=args.body,
...
class UpdateProfile(BaseApi):
    ...
    async def aupdate_profile(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_profile(
            group_id=group_id,
            embedded=embedded,
            links=links,
            created=created,
    ...
    def update_profile(
        ...
        raw_response = self.raw.update_profile(
            group_id=group_id,
            embedded=embedded,
            links=links,
            created=created,
