...
class GetRulesRaw(BaseApi):
    ...
    async def aget_rules(
        ...
        **kwargs,
        ...
        args = self._get_rules_mapped_args(
            group_id=group_id,
        )
        return await self._aget_rules_oapg(
    ...
    def get_rules(
        ...
        return self._get_rules_oapg(
            path_params=args.path,
        )

class GetRules(BaseApi):
    ...
    async def aget_rules(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_rules(
            group_id=group_id,
            **kwargs,
        )
        if validate:
    ...
    def get_rules(
        ...
        raw_response = self.raw.get_rules(
            group_id=group_id,
        )
        if validate:
            return GroupPydantic(**raw_response.body)
