...
class BaseApi(api_client.Api):
    ...
    def _deactivate_policy_lifecycle_mapped_args(
        self,
        auth_server_id: str,
        policy_id: str,
    ...
    async def _adeactivate_policy_lifecycle_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/authorizationServers/{authServerId}/policies/{policyId}/lifecycle/deactivate',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _deactivate_policy_lifecycle_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeactivatePolicyLifecycleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeactivate_policy_lifecycle(
        self,
        auth_server_id: str,
        policy_id: str,
        **kwargs,
        ...
        args = self._deactivate_policy_lifecycle_mapped_args(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
        )
        return await self._adeactivate_policy_lifecycle_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def deactivate_policy_lifecycle(
        self,
        auth_server_id: str,
        policy_id: str,
    ) -> typing.Union[
        ...
        return self._deactivate_policy_lifecycle_oapg(
            path_params=args.path,
        )

class DeactivatePolicyLifecycle(BaseApi):
    ...
    async def adeactivate_policy_lifecycle(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adeactivate_policy_lifecycle(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            **kwargs,
        )
    ...
    def deactivate_policy_lifecycle(
        ...
        raw_response = self.raw.deactivate_policy_lifecycle(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
        )
