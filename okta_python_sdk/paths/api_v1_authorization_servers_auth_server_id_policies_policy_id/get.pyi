...
class GetPoliciesRaw(BaseApi):
    ...
    async def aget_policies(
        ...
        **kwargs,
        ...
        args = self._get_policies_mapped_args(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
        )
        return await self._aget_policies_oapg(
    ...
    def get_policies(
        ...
        return self._get_policies_oapg(
            path_params=args.path,
        )

class GetPolicies(BaseApi):
    ...
    async def aget_policies(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_policies(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            **kwargs,
        )
    ...
    def get_policies(
        ...
        raw_response = self.raw.get_policies(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
        )
        if validate:
