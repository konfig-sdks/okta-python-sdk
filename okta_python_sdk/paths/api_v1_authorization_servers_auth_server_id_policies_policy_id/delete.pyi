...
class BaseApi(api_client.Api):
    ...
    def _delete_policy_by_id_mapped_args(
        self,
        auth_server_id: str,
        policy_id: str,
    ...
    async def _adelete_policy_by_id_oapg(
        self,
...
class DeletePolicyByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_policy_by_id(
        self,
        auth_server_id: str,
        policy_id: str,
        **kwargs,
        ...
        args = self._delete_policy_by_id_mapped_args(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
        )
        return await self._adelete_policy_by_id_oapg(
    ...
    def delete_policy_by_id(
        ...
        return self._delete_policy_by_id_oapg(
            path_params=args.path,
        )

class DeletePolicyById(BaseApi):
    ...
    async def adelete_policy_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_policy_by_id(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            **kwargs,
        )
    ...
    def delete_policy_by_id(
        ...
        raw_response = self.raw.delete_policy_by_id(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
        )
