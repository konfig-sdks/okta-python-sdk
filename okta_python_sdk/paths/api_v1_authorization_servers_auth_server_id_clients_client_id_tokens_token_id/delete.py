...
class BaseApi(api_client.Api):
    ...
    def _delete_auth_token_mapped_args(
        self,
        auth_server_id: str,
        client_id: str,
        token_id: str,
    ...
    async def _adelete_auth_token_oapg(
        self,
...
class DeleteAuthTokenRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_auth_token(
        self,
        auth_server_id: str,
        client_id: str,
        token_id: str,
        **kwargs,
        ...
        args = self._delete_auth_token_mapped_args(
            auth_server_id=auth_server_id,
            client_id=client_id,
            token_id=token_id,
        )
        return await self._adelete_auth_token_oapg(
    ...
    def delete_auth_token(
        ...
        return self._delete_auth_token_oapg(
            path_params=args.path,
        )

class DeleteAuthToken(BaseApi):
    ...
    async def adelete_auth_token(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_auth_token(
            auth_server_id=auth_server_id,
            client_id=client_id,
            token_id=token_id,
            **kwargs,
    ...
    def delete_auth_token(
        ...
        raw_response = self.raw.delete_auth_token(
            auth_server_id=auth_server_id,
            client_id=client_id,
            token_id=token_id,
        )
