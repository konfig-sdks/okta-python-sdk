...
class BaseApi(api_client.Api):
    ...
    def _grant_okta_support_access_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _agrant_okta_support_access_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/org/privacy/oktaSupport/grant',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _grant_okta_support_access_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GrantOktaSupportAccessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agrant_okta_support_access(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._grant_okta_support_access_mapped_args(
        )
        return await self._agrant_okta_support_access_oapg(
            **kwargs,
        )
    
    def grant_okta_support_access(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._grant_okta_support_access_oapg(
        )

class GrantOktaSupportAccess(BaseApi):
    ...
    async def agrant_okta_support_access(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agrant_okta_support_access(
            **kwargs,
        )
        if validate:
    ...
    def grant_okta_support_access(
        ...
        raw_response = self.raw.grant_okta_support_access(
        )
        if validate:
            return OrgOktaSupportSettingsObjPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrgOktaSupportSettingsObjPydantic, raw_response.body)
