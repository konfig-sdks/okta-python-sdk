...
class RevokeTokenRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arevoke_token(
        self,
        app_id: str,
        token_id: str,
        **kwargs,
        ...
        args = self._revoke_token_mapped_args(
            app_id=app_id,
            token_id=token_id,
        )
        return await self._arevoke_token_oapg(
    ...
    def revoke_token(
        ...
        return self._revoke_token_oapg(
            path_params=args.path,
        )

class RevokeToken(BaseApi):
    ...
    async def arevoke_token(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arevoke_token(
            app_id=app_id,
            token_id=token_id,
            **kwargs,
        )
    ...
    def revoke_token(
        ...
        raw_response = self.raw.revoke_token(
            app_id=app_id,
            token_id=token_id,
        )
