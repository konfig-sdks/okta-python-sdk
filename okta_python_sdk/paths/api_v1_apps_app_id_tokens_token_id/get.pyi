...
from okta_python_sdk.model.o_auth2_token import OAuth2Token as OAuth2TokenSchema

from okta_python_sdk.type.o_auth2_token import OAuth2Token

from ...api_client import Dictionary
from okta_python_sdk.pydantic.o_auth2_token import OAuth2Token as OAuth2TokenPydantic
...
SchemaFor200ResponseBodyApplicationJson = OAuth2TokenSchema
    ...
    async def _aget_token_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/apps/{appId}/tokens/{tokenId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetToken(BaseApi):
    ...
    async def aget_token(
        ...
        **kwargs,
        ...
        if validate:
            return OAuth2TokenPydantic(**raw_response.body)
        return api_client.construct_model_instance(OAuth2TokenPydantic, raw_response.body)
