...
class BaseApi(api_client.Api):
    ...
    def _delete_theme_logo_mapped_args(
        self,
        brand_id: str,
        theme_id: str,
    ...
    async def _adelete_theme_logo_oapg(
        self,
...
class DeleteThemeLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_theme_logo(
        self,
        brand_id: str,
        theme_id: str,
        **kwargs,
        ...
        args = self._delete_theme_logo_mapped_args(
            brand_id=brand_id,
            theme_id=theme_id,
        )
        return await self._adelete_theme_logo_oapg(
    ...
    def delete_theme_logo(
        ...
        return self._delete_theme_logo_oapg(
            path_params=args.path,
        )

class DeleteThemeLogo(BaseApi):
    ...
    async def adelete_theme_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_theme_logo(
            brand_id=brand_id,
            theme_id=theme_id,
            **kwargs,
        )
    ...
    def delete_theme_logo(
        ...
        raw_response = self.raw.delete_theme_logo(
            brand_id=brand_id,
            theme_id=theme_id,
        )
