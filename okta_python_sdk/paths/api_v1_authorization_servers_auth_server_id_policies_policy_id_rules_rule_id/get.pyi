...
class BaseApi(api_client.Api):
    ...
    def _get_policy_rule_by_id_mapped_args(
        self,
        auth_server_id: str,
        policy_id: str,
        rule_id: str,
    ...
    async def _aget_policy_rule_by_id_oapg(
        self,
    ...
    def _get_policy_rule_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPolicyRuleByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_policy_rule_by_id(
        self,
        auth_server_id: str,
        policy_id: str,
        rule_id: str,
        **kwargs,
        ...
        args = self._get_policy_rule_by_id_mapped_args(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
        )
        return await self._aget_policy_rule_by_id_oapg(
    ...
    def get_policy_rule_by_id(
        ...
        return self._get_policy_rule_by_id_oapg(
            path_params=args.path,
        )

class GetPolicyRuleById(BaseApi):
    ...
    async def aget_policy_rule_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_policy_rule_by_id(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
            **kwargs,
    ...
    def get_policy_rule_by_id(
        ...
        raw_response = self.raw.get_policy_rule_by_id(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
        )
