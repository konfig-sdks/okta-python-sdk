...
class BaseApi(api_client.Api):
    ...
    def _update_policy_rule_configuration_mapped_args(
        self,
        auth_server_id: str,
        policy_id: str,
        rule_id: str,
    ...
    async def _aupdate_policy_rule_configuration_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/authorizationServers/{authServerId}/policies/{policyId}/rules/{ruleId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_policy_rule_configuration_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdatePolicyRuleConfigurationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_policy_rule_configuration(
        self,
        auth_server_id: str,
        policy_id: str,
        rule_id: str,
        ...
        **kwargs,
        ...
        args = self._update_policy_rule_configuration_mapped_args(
        ...
        return await self._aupdate_policy_rule_configuration_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_policy_rule_configuration(
        self,
        auth_server_id: str,
        policy_id: str,
        rule_id: str,
        ...
        return self._update_policy_rule_configuration_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdatePolicyRuleConfiguration(BaseApi):
    ...
    async def aupdate_policy_rule_configuration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_policy_rule_configuration(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
            actions=actions,
    ...
    def update_policy_rule_configuration(
        ...
        raw_response = self.raw.update_policy_rule_configuration(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
            actions=actions,
