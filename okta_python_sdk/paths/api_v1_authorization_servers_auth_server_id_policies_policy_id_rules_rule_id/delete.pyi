...
class BaseApi(api_client.Api):
    ...
    def _delete_policy_rule_mapped_args(
        self,
        auth_server_id: str,
        policy_id: str,
        rule_id: str,
    ...
    async def _adelete_policy_rule_oapg(
        self,
...
class DeletePolicyRuleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_policy_rule(
        self,
        auth_server_id: str,
        policy_id: str,
        rule_id: str,
        **kwargs,
        ...
        args = self._delete_policy_rule_mapped_args(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
        )
        return await self._adelete_policy_rule_oapg(
    ...
    def delete_policy_rule(
        ...
        return self._delete_policy_rule_oapg(
            path_params=args.path,
        )

class DeletePolicyRule(BaseApi):
    ...
    async def adelete_policy_rule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_policy_rule(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
            **kwargs,
    ...
    def delete_policy_rule(
        ...
        raw_response = self.raw.delete_policy_rule(
            auth_server_id=auth_server_id,
            policy_id=policy_id,
            rule_id=rule_id,
        )
