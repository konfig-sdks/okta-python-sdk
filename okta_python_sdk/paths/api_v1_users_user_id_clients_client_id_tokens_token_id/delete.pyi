...
class BaseApi(api_client.Api):
    ...
    def _revoke_token_for_client_mapped_args(
        self,
        user_id: str,
        client_id: str,
        token_id: str,
    ...
    async def _arevoke_token_for_client_oapg(
        self,
    ...
    def _revoke_token_for_client_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RevokeTokenForClientRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arevoke_token_for_client(
        self,
        user_id: str,
        client_id: str,
        token_id: str,
        **kwargs,
        ...
        args = self._revoke_token_for_client_mapped_args(
            user_id=user_id,
            client_id=client_id,
            token_id=token_id,
        )
        return await self._arevoke_token_for_client_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def revoke_token_for_client(
        self,
        user_id: str,
        client_id: str,
        token_id: str,
        ...
        return self._revoke_token_for_client_oapg(
            path_params=args.path,
        )

class RevokeTokenForClient(BaseApi):
    ...
    async def arevoke_token_for_client(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arevoke_token_for_client(
            user_id=user_id,
            client_id=client_id,
            token_id=token_id,
            **kwargs,
    ...
    def revoke_token_for_client(
        ...
        raw_response = self.raw.revoke_token_for_client(
            user_id=user_id,
            client_id=client_id,
            token_id=token_id,
        )
