...
class RemoveRuleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_rule(
        self,
        policy_id: str,
        rule_id: str,
        **kwargs,
        ...
        args = self._remove_rule_mapped_args(
            policy_id=policy_id,
            rule_id=rule_id,
        )
        return await self._aremove_rule_oapg(
    ...
    def remove_rule(
        ...
        return self._remove_rule_oapg(
            path_params=args.path,
        )

class RemoveRule(BaseApi):
    ...
    async def aremove_rule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_rule(
            policy_id=policy_id,
            rule_id=rule_id,
            **kwargs,
        )
    ...
    def remove_rule(
        ...
        raw_response = self.raw.remove_rule(
            policy_id=policy_id,
            rule_id=rule_id,
        )
