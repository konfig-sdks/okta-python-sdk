...
class BaseApi(api_client.Api):
    ...
    def _extend_okta_support_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aextend_okta_support_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/org/privacy/oktaSupport/extend',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ExtendOktaSupportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aextend_okta_support(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._extend_okta_support_mapped_args(
        )
        return await self._aextend_okta_support_oapg(
            **kwargs,
        )
    ...
    def extend_okta_support(
        ...
        return self._extend_okta_support_oapg(
        )

class ExtendOktaSupport(BaseApi):
    ...
    async def aextend_okta_support(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aextend_okta_support(
            **kwargs,
        )
        if validate:
    ...
    def extend_okta_support(
        ...
        raw_response = self.raw.extend_okta_support(
        )
        if validate:
            return OrgOktaSupportSettingsObjPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrgOktaSupportSettingsObjPydantic, raw_response.body)
