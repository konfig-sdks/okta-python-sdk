...
class BaseApi(api_client.Api):
    ...
    def _get_email_template_default_content_preview_mapped_args(
        self,
        brand_id: str,
        template_name: str,
    ...
    async def _aget_email_template_default_content_preview_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/brands/{brandId}/templates/email/{templateName}/default-content/preview',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_email_template_default_content_preview_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetEmailTemplateDefaultContentPreviewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_email_template_default_content_preview(
        self,
        brand_id: str,
        template_name: str,
        **kwargs,
        ...
        args = self._get_email_template_default_content_preview_mapped_args(
            brand_id=brand_id,
            template_name=template_name,
        )
        return await self._aget_email_template_default_content_preview_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_email_template_default_content_preview(
        self,
        brand_id: str,
        template_name: str,
    ) -> typing.Union[
        ...
        return self._get_email_template_default_content_preview_oapg(
            path_params=args.path,
        )

class GetEmailTemplateDefaultContentPreview(BaseApi):
    ...
    async def aget_email_template_default_content_preview(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_email_template_default_content_preview(
            brand_id=brand_id,
            template_name=template_name,
            **kwargs,
        )
    ...
    def get_email_template_default_content_preview(
        ...
        raw_response = self.raw.get_email_template_default_content_preview(
            brand_id=brand_id,
            template_name=template_name,
        )
        if validate:
