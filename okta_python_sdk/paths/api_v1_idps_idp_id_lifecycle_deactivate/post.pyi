...
class BaseApi(api_client.Api):
    ...
    def _deactivate_idp_mapped_args(
        self,
        idp_id: str,
    ...
    async def _adeactivate_idp_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/idps/{idpId}/lifecycle/deactivate',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeactivateIdpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeactivate_idp(
        self,
        idp_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._deactivate_idp_mapped_args(
            idp_id=idp_id,
        )
        return await self._adeactivate_idp_oapg(
    ...
    def deactivate_idp(
        ...
        return self._deactivate_idp_oapg(
            path_params=args.path,
        )

class DeactivateIdp(BaseApi):
    ...
    async def adeactivate_idp(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adeactivate_idp(
            idp_id=idp_id,
            **kwargs,
        )
        if validate:
    ...
    def deactivate_idp(
        ...
        raw_response = self.raw.deactivate_idp(
            idp_id=idp_id,
        )
        if validate:
            return IdentityProviderPydantic(**raw_response.body)
