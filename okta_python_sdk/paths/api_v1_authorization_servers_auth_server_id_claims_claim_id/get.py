...
class GetClaims0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_claims_0(
        self,
        auth_server_id: str,
        claim_id: str,
        **kwargs,
        ...
        args = self._get_claims_0_mapped_args(
            auth_server_id=auth_server_id,
            claim_id=claim_id,
        )
        return await self._aget_claims_0_oapg(
    ...
    def get_claims_0(
        ...
        return self._get_claims_0_oapg(
            path_params=args.path,
        )

class GetClaims0(BaseApi):
    ...
    async def aget_claims_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_claims_0(
            auth_server_id=auth_server_id,
            claim_id=claim_id,
            **kwargs,
        )
    ...
    def get_claims_0(
        ...
        raw_response = self.raw.get_claims_0(
            auth_server_id=auth_server_id,
            claim_id=claim_id,
        )
        if validate:
