...
ClaimIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'authServerId': typing.Union[AuthServerIdSchema, str, ],
        'claimId': typing.Union[ClaimIdSchema, str, ],
    }
)
...
request_path_claim_id = api_client.PathParameter(
    name="claimId",
    style=api_client.ParameterStyle.SIMPLE,
...
class BaseApi(api_client.Api):
    ...
    def _update_claim_success_mapped_args(
        self,
        auth_server_id: str,
        claim_id: str,
    ...
    async def _aupdate_claim_success_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/authorizationServers/{authServerId}/claims/{claimId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_claim_success_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateClaimSuccessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_claim_success(
        self,
        auth_server_id: str,
        claim_id: str,
        links: typing.Optional[OAuth2ClaimLinks] = None,
        ...
        **kwargs,
        ...
        args = self._update_claim_success_mapped_args(
        ...
        return await self._aupdate_claim_success_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_claim_success(
        self,
        auth_server_id: str,
        claim_id: str,
        links: typing.Optional[OAuth2ClaimLinks] = None,
        ...
        return self._update_claim_success_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateClaimSuccess(BaseApi):
    ...
    async def aupdate_claim_success(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_claim_success(
            auth_server_id=auth_server_id,
            claim_id=claim_id,
            links=links,
            always_include_in_token=always_include_in_token,
    ...
    def update_claim_success(
        ...
        raw_response = self.raw.update_claim_success(
            auth_server_id=auth_server_id,
            claim_id=claim_id,
            links=links,
            always_include_in_token=always_include_in_token,
