...
class BaseApi(api_client.Api):
    ...
    def _get_okta_support_settings_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_okta_support_settings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/org/privacy/oktaSupport',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_okta_support_settings_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetOktaSupportSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_okta_support_settings(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_okta_support_settings_mapped_args(
        )
        return await self._aget_okta_support_settings_oapg(
            **kwargs,
        )
    
    def get_okta_support_settings(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._get_okta_support_settings_oapg(
        )

class GetOktaSupportSettings(BaseApi):
    ...
    async def aget_okta_support_settings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_okta_support_settings(
            **kwargs,
        )
        if validate:
    ...
    def get_okta_support_settings(
        ...
        raw_response = self.raw.get_okta_support_settings(
        )
        if validate:
            return OrgOktaSupportSettingsObjPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrgOktaSupportSettingsObjPydantic, raw_response.body)
