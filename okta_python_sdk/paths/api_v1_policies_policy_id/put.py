...
class BaseApi(api_client.Api):
    ...
    def _update_operation_mapped_args(
        self,
        policy_id: str,
    ...
    async def _aupdate_operation_oapg(
        self,
...
class UpdateOperationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_operation(
        self,
        policy_id: str,
        description: typing.Optional[str] = None,
        embedded: typing.Optional[PolicyEmbedded] = None,
        ...
        **kwargs,
        ...
        args = self._update_operation_mapped_args(
            policy_id=policy_id,
        ...
        return await self._aupdate_operation_oapg(
            body=args.body,
    ...
    def update_operation(
        ...
        return self._update_operation_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateOperation(BaseApi):
    ...
    async def aupdate_operation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_operation(
            policy_id=policy_id,
            description=description,
            embedded=embedded,
            links=links,
    ...
    def update_operation(
        ...
        raw_response = self.raw.update_operation(
            policy_id=policy_id,
            description=description,
            embedded=embedded,
            links=links,
