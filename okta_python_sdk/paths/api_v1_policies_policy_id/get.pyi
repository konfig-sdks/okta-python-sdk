...
class GetPolicyRaw(BaseApi):
    ...
    async def aget_policy(
        ...
        **kwargs,
        ...
        args = self._get_policy_mapped_args(
            policy_id=policy_id,
            expand=expand,
        )
        return await self._aget_policy_oapg(
    ...
    def get_policy(
        ...
        return self._get_policy_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPolicy(BaseApi):
    ...
    async def aget_policy(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_policy(
            policy_id=policy_id,
            expand=expand,
            **kwargs,
        )
    ...
    def get_policy(
        ...
        raw_response = self.raw.get_policy(
            policy_id=policy_id,
            expand=expand,
        )
        if validate:
