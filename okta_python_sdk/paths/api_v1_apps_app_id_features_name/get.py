...
class GetFeatureRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_feature(
        self,
        app_id: str,
        name: str,
        **kwargs,
        ...
        args = self._get_feature_mapped_args(
            app_id=app_id,
            name=name,
        )
        return await self._aget_feature_oapg(
...
class GetFeature(BaseApi):
    ...
    async def aget_feature(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_feature(
            app_id=app_id,
            name=name,
            **kwargs,
        )
    ...
    def get_feature(
        ...
        raw_response = self.raw.get_feature(
            app_id=app_id,
            name=name,
        )
        if validate:
