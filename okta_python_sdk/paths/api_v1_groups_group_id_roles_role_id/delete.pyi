...
class BaseApi(api_client.Api):
    ...
    def _unassign_role_mapped_args(
        self,
        group_id: str,
        role_id: str,
    ...
    async def _aunassign_role_oapg(
        self,
...
class UnassignRoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunassign_role(
        self,
        group_id: str,
        role_id: str,
        **kwargs,
        ...
        args = self._unassign_role_mapped_args(
            group_id=group_id,
            role_id=role_id,
        )
        return await self._aunassign_role_oapg(
    ...
    def unassign_role(
        ...
        return self._unassign_role_oapg(
            path_params=args.path,
        )

class UnassignRole(BaseApi):
    ...
    async def aunassign_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunassign_role(
            group_id=group_id,
            role_id=role_id,
            **kwargs,
        )
    ...
    def unassign_role(
        ...
        raw_response = self.raw.unassign_role(
            group_id=group_id,
            role_id=role_id,
        )
