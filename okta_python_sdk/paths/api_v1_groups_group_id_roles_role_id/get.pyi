...
class BaseApi(api_client.Api):
    ...
    def _get_role_success_mapped_args(
        self,
        group_id: str,
        role_id: str,
    ...
    async def _aget_role_success_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/groups/{groupId}/roles/{roleId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRoleSuccessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_role_success(
        self,
        group_id: str,
        role_id: str,
        **kwargs,
        ...
        args = self._get_role_success_mapped_args(
            group_id=group_id,
            role_id=role_id,
        )
        return await self._aget_role_success_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_role_success(
        self,
        group_id: str,
        role_id: str,
    ) -> typing.Union[
        ...
        return self._get_role_success_oapg(
            path_params=args.path,
        )

class GetRoleSuccess(BaseApi):
    ...
    async def aget_role_success(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_role_success(
            group_id=group_id,
            role_id=role_id,
            **kwargs,
        )
    ...
    def get_role_success(
        ...
        raw_response = self.raw.get_role_success(
            group_id=group_id,
            role_id=role_id,
        )
        if validate:
