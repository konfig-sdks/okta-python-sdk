...
class BaseApi(api_client.Api):
    ...
    def _poll_factor_transaction_status_mapped_args(
        self,
        user_id: str,
        factor_id: str,
        transaction_id: str,
    ...
    async def _apoll_factor_transaction_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/users/{userId}/factors/{factorId}/transactions/{transactionId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _poll_factor_transaction_status_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class PollFactorTransactionStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apoll_factor_transaction_status(
        self,
        user_id: str,
        factor_id: str,
        transaction_id: str,
        **kwargs,
        ...
        args = self._poll_factor_transaction_status_mapped_args(
            user_id=user_id,
            factor_id=factor_id,
            transaction_id=transaction_id,
        )
        return await self._apoll_factor_transaction_status_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def poll_factor_transaction_status(
        self,
        user_id: str,
        factor_id: str,
        transaction_id: str,
        ...
        return self._poll_factor_transaction_status_oapg(
            path_params=args.path,
        )

class PollFactorTransactionStatus(BaseApi):
    ...
    async def apoll_factor_transaction_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apoll_factor_transaction_status(
            user_id=user_id,
            factor_id=factor_id,
            transaction_id=transaction_id,
            **kwargs,
    ...
    def poll_factor_transaction_status(
        ...
        raw_response = self.raw.poll_factor_transaction_status(
            user_id=user_id,
            factor_id=factor_id,
            transaction_id=transaction_id,
        )
