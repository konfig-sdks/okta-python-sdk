...
class BaseApi(api_client.Api):
    ...
    def _delete_theme_favicon_mapped_args(
        self,
        brand_id: str,
        theme_id: str,
    ...
    async def _adelete_theme_favicon_oapg(
        self,
    ...
    def _delete_theme_favicon_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteThemeFaviconRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_theme_favicon(
        self,
        brand_id: str,
        theme_id: str,
        **kwargs,
        ...
        args = self._delete_theme_favicon_mapped_args(
            brand_id=brand_id,
            theme_id=theme_id,
        )
        return await self._adelete_theme_favicon_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_theme_favicon(
        self,
        brand_id: str,
        theme_id: str,
    ) -> typing.Union[
        ...
        return self._delete_theme_favicon_oapg(
            path_params=args.path,
        )

class DeleteThemeFavicon(BaseApi):
    ...
    async def adelete_theme_favicon(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_theme_favicon(
            brand_id=brand_id,
            theme_id=theme_id,
            **kwargs,
        )
    ...
    def delete_theme_favicon(
        ...
        raw_response = self.raw.delete_theme_favicon(
            brand_id=brand_id,
            theme_id=theme_id,
        )
