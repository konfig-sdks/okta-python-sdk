...
class GetScopes0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_scopes_0(
        self,
        auth_server_id: str,
        scope_id: str,
        **kwargs,
        ...
        args = self._get_scopes_0_mapped_args(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
        )
        return await self._aget_scopes_0_oapg(
    ...
    def get_scopes_0(
        ...
        return self._get_scopes_0_oapg(
            path_params=args.path,
        )

class GetScopes0(BaseApi):
    ...
    async def aget_scopes_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_scopes_0(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
            **kwargs,
        )
    ...
    def get_scopes_0(
        ...
        raw_response = self.raw.get_scopes_0(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
        )
        if validate:
