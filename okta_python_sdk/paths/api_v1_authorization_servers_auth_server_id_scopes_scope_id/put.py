...
class BaseApi(api_client.Api):
    ...
    def _update_scope_success_mapped_args(
        self,
        auth_server_id: str,
        scope_id: str,
    ...
    async def _aupdate_scope_success_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/authorizationServers/{authServerId}/scopes/{scopeId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_scope_success_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateScopeSuccessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_scope_success(
        self,
        auth_server_id: str,
        scope_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_scope_success_mapped_args(
        ...
        return await self._aupdate_scope_success_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_scope_success(
        self,
        auth_server_id: str,
        scope_id: str,
        description: typing.Optional[str] = None,
        ...
        return self._update_scope_success_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateScopeSuccess(BaseApi):
    ...
    async def aupdate_scope_success(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_scope_success(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
            description=description,
            consent=consent,
    ...
    def update_scope_success(
        ...
        raw_response = self.raw.update_scope_success(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
            description=description,
            consent=consent,
