...
class DeleteScopeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_scope(
        self,
        auth_server_id: str,
        scope_id: str,
        **kwargs,
        ...
        args = self._delete_scope_mapped_args(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
        )
        return await self._adelete_scope_oapg(
...
class DeleteScope(BaseApi):
    ...
    async def adelete_scope(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_scope(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
            **kwargs,
        )
    ...
    def delete_scope(
        ...
        raw_response = self.raw.delete_scope(
            auth_server_id=auth_server_id,
            scope_id=scope_id,
        )
