...
class BaseApi(api_client.Api):
    ...
    def _get_email_customization_preview_mapped_args(
        self,
        brand_id: str,
        template_name: str,
    ...
    async def _aget_email_customization_preview_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/brands/{brandId}/templates/email/{templateName}/customizations/{customizationId}/preview',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_email_customization_preview_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetEmailCustomizationPreviewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_email_customization_preview(
        self,
        brand_id: str,
        template_name: str,
        customization_id: str,
        **kwargs,
        ...
        args = self._get_email_customization_preview_mapped_args(
            brand_id=brand_id,
            template_name=template_name,
            customization_id=customization_id,
        )
        return await self._aget_email_customization_preview_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_email_customization_preview(
        self,
        brand_id: str,
        template_name: str,
        customization_id: str,
        ...
        return self._get_email_customization_preview_oapg(
            path_params=args.path,
        )

class GetEmailCustomizationPreview(BaseApi):
    ...
    async def aget_email_customization_preview(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_email_customization_preview(
            brand_id=brand_id,
            template_name=template_name,
            customization_id=customization_id,
            **kwargs,
    ...
    def get_email_customization_preview(
        ...
        raw_response = self.raw.get_email_customization_preview(
            brand_id=brand_id,
            template_name=template_name,
            customization_id=customization_id,
        )
