...
class BaseApi(api_client.Api):
    ...
    def _get_signing_key_credential_by_idp_mapped_args(
        self,
        idp_id: str,
        key_id: str,
    ...
    async def _aget_signing_key_credential_by_idp_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/idps/{idpId}/credentials/keys/{keyId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_signing_key_credential_by_idp_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSigningKeyCredentialByIdpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_signing_key_credential_by_idp(
        self,
        idp_id: str,
        key_id: str,
        **kwargs,
        ...
        args = self._get_signing_key_credential_by_idp_mapped_args(
            idp_id=idp_id,
            key_id=key_id,
        )
        return await self._aget_signing_key_credential_by_idp_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_signing_key_credential_by_idp(
        self,
        idp_id: str,
        key_id: str,
    ) -> typing.Union[
        ...
        return self._get_signing_key_credential_by_idp_oapg(
            path_params=args.path,
        )

class GetSigningKeyCredentialByIdp(BaseApi):
    ...
    async def aget_signing_key_credential_by_idp(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_signing_key_credential_by_idp(
            idp_id=idp_id,
            key_id=key_id,
            **kwargs,
        )
    ...
    def get_signing_key_credential_by_idp(
        ...
        raw_response = self.raw.get_signing_key_credential_by_idp(
            idp_id=idp_id,
            key_id=key_id,
        )
        if validate:
