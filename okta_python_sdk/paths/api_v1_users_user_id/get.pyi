...
class BaseApi(api_client.Api):
    ...
    def _get_okta_user_mapped_args(
        self,
        user_id: str,
    ...
    async def _aget_okta_user_oapg(
        self,
...
class GetOktaUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_okta_user(
        self,
        user_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_okta_user_mapped_args(
            user_id=user_id,
        )
        return await self._aget_okta_user_oapg(
    ...
    def get_okta_user(
        ...
        return self._get_okta_user_oapg(
            path_params=args.path,
        )

class GetOktaUser(BaseApi):
    ...
    async def aget_okta_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_okta_user(
            user_id=user_id,
            **kwargs,
        )
        if validate:
    ...
    def get_okta_user(
        ...
        raw_response = self.raw.get_okta_user(
            user_id=user_id,
        )
        if validate:
            return UserPydantic(**raw_response.body)
