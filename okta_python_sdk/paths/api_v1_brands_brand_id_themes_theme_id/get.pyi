...
class BaseApi(api_client.Api):
    ...
    def _get_theme_by_id_mapped_args(
        self,
        brand_id: str,
        theme_id: str,
    ...
    async def _aget_theme_by_id_oapg(
        self,
...
class GetThemeByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_theme_by_id(
        self,
        brand_id: str,
        theme_id: str,
        **kwargs,
        ...
        args = self._get_theme_by_id_mapped_args(
            brand_id=brand_id,
            theme_id=theme_id,
        )
        return await self._aget_theme_by_id_oapg(
    ...
    def get_theme_by_id(
        ...
        return self._get_theme_by_id_oapg(
            path_params=args.path,
        )

class GetThemeById(BaseApi):
    ...
    async def aget_theme_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_theme_by_id(
            brand_id=brand_id,
            theme_id=theme_id,
            **kwargs,
        )
    ...
    def get_theme_by_id(
        ...
        raw_response = self.raw.get_theme_by_id(
            brand_id=brand_id,
            theme_id=theme_id,
        )
        if validate:
