...
class RemoveZoneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_zone(
        self,
        zone_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_zone_mapped_args(
            zone_id=zone_id,
        )
        return await self._aremove_zone_oapg(
    ...
    def remove_zone(
        ...
        return self._remove_zone_oapg(
            path_params=args.path,
        )

class RemoveZone(BaseApi):
    ...
    async def aremove_zone(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_zone(
            zone_id=zone_id,
            **kwargs,
        )
    ...
    def remove_zone(
        ...
        raw_response = self.raw.remove_zone(
            zone_id=zone_id,
        )
