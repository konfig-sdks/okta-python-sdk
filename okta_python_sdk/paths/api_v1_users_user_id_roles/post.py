...
SchemaFor201ResponseBodyApplicationJson = RoleSchema
...
class AssignRoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_role(
        self,
        user_id: str,
        type: typing.Optional[RoleType] = None,
        disable_notifications: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._assign_role_mapped_args(
            body=body,
            user_id=user_id,
            type=type,
            disable_notifications=disable_notifications,
        )
        return await self._aassign_role_oapg(
            body=args.body,
    ...
    def assign_role(
        ...
        return self._assign_role_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AssignRole(BaseApi):
    ...
    async def aassign_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aassign_role(
            body=body,
            user_id=user_id,
            type=type,
            disable_notifications=disable_notifications,
    ...
    def assign_role(
        ...
        raw_response = self.raw.assign_role(
            body=body,
            user_id=user_id,
            type=type,
            disable_notifications=disable_notifications,
