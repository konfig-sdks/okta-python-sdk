...
class BaseApi(api_client.Api):
    ...
    def _get_key_credential_by_idp_mapped_args(
        self,
        key_id: str,
    ...
    async def _aget_key_credential_by_idp_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/idps/credentials/keys/{keyId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_key_credential_by_idp_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetKeyCredentialByIdpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_key_credential_by_idp(
        self,
        key_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_key_credential_by_idp_mapped_args(
            key_id=key_id,
        )
        return await self._aget_key_credential_by_idp_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_key_credential_by_idp(
        self,
        key_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_key_credential_by_idp_oapg(
            path_params=args.path,
        )

class GetKeyCredentialByIdp(BaseApi):
    ...
    async def aget_key_credential_by_idp(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_key_credential_by_idp(
            key_id=key_id,
            **kwargs,
        )
        if validate:
    ...
    def get_key_credential_by_idp(
        ...
        raw_response = self.raw.get_key_credential_by_idp(
            key_id=key_id,
        )
        if validate:
            return JsonWebKeyPydantic(**raw_response.body)
