...
class BaseApi(api_client.Api):
    ...
    def _delete_email_customization_mapped_args(
        self,
        brand_id: str,
        template_name: str,
    ...
    async def _adelete_email_customization_oapg(
        self,
    ...
    def _delete_email_customization_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteEmailCustomizationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_email_customization(
        self,
        brand_id: str,
        template_name: str,
        customization_id: str,
        **kwargs,
        ...
        args = self._delete_email_customization_mapped_args(
            brand_id=brand_id,
            template_name=template_name,
            customization_id=customization_id,
        )
        return await self._adelete_email_customization_oapg(
    ...
    def delete_email_customization(
        ...
        return self._delete_email_customization_oapg(
            path_params=args.path,
        )

class DeleteEmailCustomization(BaseApi):
    ...
    async def adelete_email_customization(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_email_customization(
            brand_id=brand_id,
            template_name=template_name,
            customization_id=customization_id,
            **kwargs,
    ...
    def delete_email_customization(
        ...
        raw_response = self.raw.delete_email_customization(
            brand_id=brand_id,
            template_name=template_name,
            customization_id=customization_id,
        )
